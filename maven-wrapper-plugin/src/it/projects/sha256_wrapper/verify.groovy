...
// wrapperSha256Sum is deprecated: the plugin must no longer write it, and must say so
assert !properties.text.contains('wrapperSha256Sum')
assert !properties.text.contains('wrapperSha512Sum')

log = new File(basedir, 'build.log').text
assert log.contains('wrapperSha256Sum is deprecated and ignored')
